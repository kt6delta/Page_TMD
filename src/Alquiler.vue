        ...
        <main class="bg-white w-full h-3/4 relative">
            <div class="flex items-center flex-col">
                ...
                <p class="text-gray text-xl font-serif text-center mx-2 mb-4">
                    ...
                    <span class="transform -skew-x-12 inline-block"> soporte técnico y asesoría que permite a todos nuestros clientes mantener su operación logística
                        de manera continua y eficiente.</span>
                    <span class="transform -skew-x-12 inline-block">
                    Nuestra experiencia, solidez y compromiso, permiten optimizar los recursos, aumentar la eficiencia y
