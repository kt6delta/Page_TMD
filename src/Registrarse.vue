        ...
        <main class="my-2 bg-white w-full h-5/6 md:h-screen relative">
            <div class="w-full h-full flex items-center justify-center flex-col">
                ...
                <form class="bg-white w-5/6 mb-4 shadow-md rounded px-3 pt-3 pb-4 md:bg-black-0 md:w-1/2 md:h-1/3 md:mb-10 flex flex-col justify-center">
                    <div class="mb-4">
                        <label class="block text-gray md:text-white md:text-2xl font-serif italic text-xl font-bold mb-2" for="username">
                            Usuario
                        </label>
                        <div class="relative">
                    ...
                    <div class="flex items-center justify-center">
                        <router-link :to="username ? { name: 'Registro_Correo', params: { user: this.username } } : '#'"
                            tag="button" :class="{ 'cursor-not-allowed': isButtonDisabled }"
