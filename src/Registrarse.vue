    ...
    <div class="w-full h-scree bg-white">
        <main class="my-2 bg-white w-full h-5/6 md:h-screen relative">
            <div class="w-full h-full flex items-center justify-center flex-col">
                ...
                <form
                    class="bg-white w-5/6 mb-4 shadow-md rounded px-3 pt-3 pb-4 md:bg-black-0 md:w-1/2 md:h-1/3 md:mb-10 flex flex-col justify-center">
                    <div class="mb-4">
                        <label
                            class="block text-gray md:text-white md:text-2xl font-serif italic text-xl font-bold mb-2"
                            for="username">
                            Usuario
                        </label>
                        <div class="relative">
                ...
                <div class="flex flex-col items-center justify-center">
                    <button
                        ...
                        <p class="text-xl md:text-2xl text-black-0 font-bold font-serif italic ml-2">Continue con Google
                        </p>
                    </button>
                    <button
                        class="mb-3 md:mb-6 inline-flex bg-white  py-1 px-3 rounded focus:outline-none focus:shadow-outline shadow appearance-none border border-yellow-2 w-full leading-tight focus:shadow-outline"
                        ...
                        <p class="text-xl md:text-2xl text-black-0 font-bold font-serif italic ml-2">Continue con
                            Facebook
                        </p>
                    </button>
                    <button
                        ...
                        <p class="text-xl md:text-2xl text-black-0 font-bold font-serif italic ml-2">Continua con Apple
                        </p>
                    </button>
                </div>
            </div>
