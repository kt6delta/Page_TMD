    ...
    <div class="container mx-auto flex flex-col md:flex-row justify-center items-center py-4 md:py-0">
      <div class="order-1 md:order-2 w-full md:w-1/3 flex flex-col items-center p-2">
        ...
        <div class="flex flex-row justify-center p-2 space-x-4">
          <a href="https://wa.me/573168770708">
            <img src="./icons/whatsapp.svg" class="w-10">
          </a>
      ...
      <div class="order-2 md:order-1 w-full md:w-1/3 text-center text-sm md:text-base font-Fuente_primaria text-primary my-4 md:my-0 ">
        <ul>
          ...
          <li>3106734889</li>
          <li>
            <span class="md:hidden">comercial1@tecnimontacargasdual.net</span>
            <span class="hidden md:block">comercial1@</span>
            <span class="hidden md:block">tecnimontacargasdual.net</span>
          </li>
        </ul>
      </div>
      ...
      <div class="order-3 w-full md:w-1/3 text-center text-sm md:text-base font-Fuente_primaria text-primary my-4 md:my-0">
        <ul>
          ...
          <li>
            ...
            <span class="hidden md:block">Bogota D.C, Colombia,</span>
            <span class="hidden md:block">C. P. 110911</span>
          </li>
        </ul>
      </div>
    </div>
